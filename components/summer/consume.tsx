  ...
  return (
    <Container id="album">
      ...
      <Consumption>
        ...
        <Month>
          <February>
            <Text>5월의 대중음악 총 소비량</Text>
            <Result>455752377</Result>
            {/* <Button onClick={onClick}>자세히보기</Button> */}
          </February>
          <March>
            <Text>6월의 대중음악 총 소비량</Text>
            <Result>467776531</Result>
            {/* <Button>자세히보기</Button> */}
          </March>
          <April>
            <Text>7월의 대중음악 총 소비량</Text>
            <Result>489629046</Result>
            {/* <Button>자세히보기</Button> */}
          </April>
        </Month>
      </Consumption>
